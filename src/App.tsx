...
// kept for possible reuse; wraps lines to avoid horizontal scroll
      ...
      <Section id="hero" className="pt-16 sm:pt-24 pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <h1 className="mt-2 text-4xl sm:text-6xl font-semibold tracking-tight">Ship faster. Ship smarter.</h1>
          ...
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.05 }}>
            <Card className="p-5 flex justify-center items-center">
              <img src="/skeleton.svg" alt="Product UI placeholder" className="w-full h-auto rounded-lg" />
            </Card>
          </motion.div>
        </div>
      </Section>
      ...
      <Section id="why" className="py-10 sm:py-14">
        <div className="grid md:grid-cols-3 gap-5">
          ...
          <Card className="p-6">
            ...
            <p className="text-white/70 text-sm leading-relaxed">See the plan immediately — no waiting.</p>
          </Card>
          ...
          <Card className="p-6">
            ...
            <p className="text-white/70 text-sm leading-relaxed">Run multiple tasks in parallel and keep shipping.</p>
          </Card>
        </div>
      </Section>
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          <div>
            ...
            <ol className="list-decimal pl-5 space-y-3 text-white/80">
              <li>
                <span className="font-medium text-white">You describe what you want.</span>
              </li>
              <li>
                <span className="font-medium text-white">Multi previews the plan before it touches your code.</span>
              </li>
              <li>
                <span className="font-medium text-white">Run it.</span> Undo or fork with one click.
              </li>
            </ol>
          </div>
        ...
        <Card className="p-6">
          <div className="grid md:grid-cols-2 gap-6 items-center">
            <div>
              ...
              <p className="text-white/80 max-w-prose">Stay in your editor. Multi fits your flow, not the other way around.</p>
            </div>
            <div className="font-mono text-sm text-white/80">
              <div className="rounded-lg border border-white/10 p-4">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-center justify-between">
                    <span>executor</span>
                    <span className="text-white/60">running ×3</span>
                  </li>
                  <li className="flex items-center justify-between">
                    <span>forks</span>
                    <span className="text-white/60">2 open</span>
                  </li>
                  <li className="flex items-center justify-between">
                    <span>snapshots</span>
      ...
      <Section id="reliability" className="py-10 sm:py-16">
        <div className="grid md:grid-cols-2 gap-6 items-start">
          <div>
            ...
            <p className="text-white/80 max-w-prose">Ship confidently. Multi keeps your work safe — easy rollback, fewer crashes.</p>
          </div>
          <Card className="p-6">
      ...
      <footer className="border-t border-white/10 py-10">
        <Section className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <nav className="flex items-center gap-5 text-white/80 text-sm">
            <a href="#" className="hover:text-white" aria-label="Docs">
              Docs
            </a>
            <a href="#" className="hover:text-white" aria-label="GitHub">
              GitHub
            </a>
            <a href="#" className="hover:text-white" aria-label="Privacy">
              Privacy
            </a>
          </nav>
        </Section>
